...
*/
#ifndef _FCITX_LIBIME_CONSTANTS_H_
#define _FCITX_LIBIME_CONSTANTS_H_

namespace libime {

constexpr float DEFAULT_USER_LANGUAGE_MODEL_UNIGRAM_WEIGHT = 3;
constexpr float DEFAULT_USER_LANGUAGE_MODEL_BIGRAM_WEIGHT = 7;
constexpr float DEFAULT_USER_LANGUAGE_MODEL_PENALTY_FACTOR = 1;
...
#endif // _FCITX_LIBIME_CONSTANTS_H_
