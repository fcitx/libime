...
const PinyinMap &getPinyinMap() {
    static const PinyinMap pinyinMap = {
        ...
        {"xion", PinyinInitial::X, PinyinFinal::IONG, PinyinFuzzyFlag::ION_IONG},
        ...
        {"qion", PinyinInitial::Q, PinyinFinal::IONG, PinyinFuzzyFlag::ION_IONG},
        ...
        {"jion", PinyinInitial::J, PinyinFinal::IONG, PinyinFuzzyFlag::ION_IONG},
