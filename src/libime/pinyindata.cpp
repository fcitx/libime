...
const std::unordered_set<int16_t> &getEncodedInitialFinal() {
    static const std::unordered_set<int16_t> encodedInitialFinal = {
        444, 169, 264, 325, 268, 277, 283, 218, 341, 293, 219, 221, 148, 223,
        43,  224, 228, 242, 244, 169, 31,  171, 535, 172, 285, 173, 188, 184,
        387, 185, 245, 152, 180, 96,  24,  304, 193, 187, 145, 199, 83,  48,
        49,  50,  51,  54,  55,  365, 306, 191, 170, 79,  56,  61,  66,  122,
        391, 240, 63,  67,  165, 222, 71,  53,  278, 413, 149, 10,  487, 150,
        362, 227, 586, 162, 164, 160, 159, 136, 533, 161, 239, 167, 173, 175,
        110, 562, 564, 493, 26,  436, 52,  32,  415, 114, 220, 156, 18,  37,
        42,  39,  146, 25,  40,  45,  34,  303, 138, 292, 305, 316, 311, 179,
        321, 317, 410, 411, 112, 270, 412, 281, 364, 523, 284, 7,   538, 183,
        241, 328, 247, 432, 416, 534, 504, 178, 397, 329, 196, 368, 287, 509,
        266, 307, 279, 433, 507, 340, 384, 421, 440, 47,  147, 525, 340, 141,
        334, 155, 443, 301, 331, 505, 414, 529, 149, 460, 186, 216, 216, 516,
        240, 531, 124, 515, 326, 558, 218, 280, 344, 438, 310, 551, 435, 151,
        411, 509, 172, 265, 64,  459, 330, 483, 193, 433, 527, 349, 196, 435,
        6,   308, 359, 123, 532, 445, 217, 107, 559, 297, 517, 65,  147, 537,
        327, 437, 135, 484, 333, 157, 371, 363, 384, 123, 528, 508, 176, 389,
        148, 309, 419, 461, 362, 182, 286, 434, 2,   347, 348, 243, 342, 341,
        181, 455, 345, 197, 336, 163, 432, 439, 366, 436, 360, 126, 343, 437,
        179, 251, 390, 267, 373, 481, 396, 457, 338, 361, 143, 132, 28,  131,
        413, 133, 506, 128, 530, 144, 125, 176, 174, 392, 508, 337, 241, 485,
        514, 332, 36,  58,  69,  282, 101, 335, 121, 200, 120, 385, 408, 507,
        111, 145, 503, 492, 491, 13,  536, 560, 409, 30,  488, 412, 387, 60,
        16,  410, 407, 388, 246, 168, 483, 482, 27,  480, 269, 443, 420, 386,
        339, 189, 431, 361, 302, 263, 221, 252, 248, 246, 245, 244, 386, 243,
        242, 217, 219, 457, 222, 220, 3,   215, 204, 203, 200, 199, 198, 363,
        197, 195, 194, 192, 15,  95,  84,  82,  88,  108, 80,  78,  75,  74,
        72,  561, 557, 121, 125, 124, 119, 113, 117, 109, 104, 103, 102, 459,
        100, 99,  98,  97,  481, 485, 4,   484, 479, 468, 467, 469, 385, 389,
        390, 388, 383, 372, 367, 365, 364, 360, 464, 463, 461, 460, 458, 456,
        23,  21,  19,  8,   1,   0,   556, 555, 554, 553, 552,
    };
